  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      if (video && inputs.title && inputs.desc && tags.length>0) {
        ...
        const res = await axios.post(`https://vid-stream-frontend.vercel.app/api/videos/`, { ...inputs, tags });
        ...
        const res2 = await axios.put(`https://vid-stream-frontend.vercel.app/api/users/userInfo/${res.data._id}`);
